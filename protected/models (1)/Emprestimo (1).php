...
class Emprestimo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Duracao, Data_Locacao, Data_Devolucao, Dia_devolvido', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Id, Duracao, Id_cliente, Id_filme, Data_Locacao, Data_Devolucao, Dia_devolvido', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('Dia_devolvido',$this->Dia_devolvido,true);
